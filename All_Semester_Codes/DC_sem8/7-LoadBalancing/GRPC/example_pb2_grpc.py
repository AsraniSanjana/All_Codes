...
class MyServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetCPUUtilization = channel.unary_unary(
                '/example.MyService/GetCPUUtilization',
                request_serializer=example__pb2.Empty.SerializeToString,
                response_deserializer=example__pb2.CPUUtilization.FromString,
                )
...
class MyServiceServicer(object):
    ...
    def GetCPUUtilization(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MyServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetCPUUtilization': grpc.unary_unary_rpc_method_handler(
                    servicer.GetCPUUtilization,
                    request_deserializer=example__pb2.Empty.FromString,
                    response_serializer=example__pb2.CPUUtilization.SerializeToString,
            ),
    }
...
class MyService(object):
    ...
    def GetCPUUtilization(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/example.MyService/GetCPUUtilization',
            example__pb2.Empty.SerializeToString,
            example__pb2.CPUUtilization.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
